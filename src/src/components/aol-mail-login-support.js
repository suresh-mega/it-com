...
const about = () => {
    return <div>
        ...
        <Helmet>
            ...
            <meta property="og:image" content="http://192.168.56.1:3000/assets/images/support.png"/>
            ...
            <meta name="twitter:image" content="http://192.168.56.1:3000/assets/images/social-support.png"/>
        ...
        <Navbar />
        <PageHeader headertitle="Aol Mail Support" headerimage="http://192.168.56.1:3000/assets/images/banner-aol-support.jpg"/>
        <ServiceV5  />
        <Subscribe  />
